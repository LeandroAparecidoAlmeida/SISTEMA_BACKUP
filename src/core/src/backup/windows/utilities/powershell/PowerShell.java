...
public class PowerShell implements AutoCloseable {
     ...
     */
    public PowerShell configuration(Map<String, String> config) throws IOException {
        this.waitPause = Integer.valueOf((config != null && config.get("waitPause") != null) ? config.get("waitPause")
     ...
     * @throws PowerShellNotAvailableException if PowerShell is not installed in the system
     */
    public static PowerShell openSession(String customPowerShellExecutablePath) 
    throws PowerShellNotAvailableException, InterruptedException, ExecutionException, IOException {
    ...
    private PowerShell initalize(String powerShellExecutablePath) throws PowerShellNotAvailableException, InterruptedException, ExecutionException {
     ...
     */
    public PowerShellResponse executeCommand(String command) throws InterruptedException,
    ExecutionException {
        String commandOutput = "";
        boolean isError = false;
        boolean timeout = false;
        checkState();
        PowerShellCommandProcessor commandProcessor = new PowerShellCommandProcessor(
            "standard",
            p.getInputStream(),
            this.waitPause,
            this.scriptMode);
     ...
     */
    public static PowerShellResponse executeSingleCommand(String command) throws Exception {
        PowerShellResponse response = null;
        try (PowerShell session = PowerShell.openSession()) {
            response = session.executeCommand(command);
        } catch (PowerShellNotAvailableException ex) {
            throw new Exception("PowerShell not available");
        }
        return response;
    }
     ...
     * @return boolean
     */
    public boolean isLastCommandInError() throws InterruptedException, ExecutionException {
     ...
     * @return response with the output of the command
     */
    public PowerShellResponse executeScript(String scriptPath) throws InterruptedException,
    ExecutionException {
     ...
     * @return response with the output of the command
     */
    public PowerShellResponse executeScript(BufferedReader srcReader) throws InterruptedException, 
    ...
    private File createWriteTempFile(BufferedReader srcReader) throws IOException {
    ...
    private long getPID() throws InterruptedException, ExecutionException {
